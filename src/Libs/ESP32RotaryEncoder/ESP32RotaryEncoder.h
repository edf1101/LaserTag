...
class RotaryEncoder {
  ...
  public:
     ...
     */
    void onTurned( std::function<void(long)> f );
     ...
     */
    void onPressed( std::function<void(long)> f );
  ...
  private:
    ...
    std::function<void(long)> callbackEncoderChanged = NULL;
    std::function<void(long)> callbackButtonPressed = NULL;
